...
- [x] `AUTH-PROVIDER-DECISION-01`: retenir le fournisseur OIDC initial et separer les clients local, beta et production, sans secret.
...
- [x] `HEALTH-FIELD-LINKS-01`: afficher les signaux sanitaires utiles depuis visites, ruches et cockpit sans surcharger.
...
- [x] `FIELD-SEED-SCENARIOS-01`: enrichir les donnees fictives de developpement pour couvrir plusieurs cas terrain sans donnee personnelle.
